...
\begin{figure}[htbp]
  \centering
  \includegraphics[width = 200pt]{images/agoraOverview}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width = 200pt]{images/sttc}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width = 200pt]{images/xorSpace}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width = 200pt]{images/sttRttc}
  \caption{}
\end{figure}
