...
% Add title elements
\input{title}
\author{{David L. Salamon, Gustav Simonsson, Jay Freeman, Brian J. Fox} \\ {{and Brian Vohaska with Stephen F. Bell, and Steven Waterhouse, Ph.D.}}}
%% \author{Orchid Labs, Inc.}
\date{\today{} \\ Version 0.9.2}
