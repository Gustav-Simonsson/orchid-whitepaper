...
Justin Sheek, Professor Vigna, Professor Boneh. Add people!
...
The address of an Econ is defined to be $H(initial Medallion)$.
...
\subsubsection{Grabbing all user's IP addresses}
