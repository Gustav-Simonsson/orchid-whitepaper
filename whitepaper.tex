...
Although the \Mesh{} system is not used when a Customer connects
...
through the pricing mechanism, will allow for graceful handling of a
change in balance between buyers and sellers.

For example, if Relays are in short supply, rather than
