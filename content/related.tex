...
[THIS SECTION NEEDS work - TOR was Bram Cohen an then Dingeldine etc. funded by ARPA https://en.wikipedia.org/wiki/Tor_(anonymity_network)]
...
\subsubsection{Etherum and \orchnet{} compliance with ERC20/ERC23}
...
ERC23\cite{41} is a backwards-compatible extension to ERC20 which solves several issues around accidental transfer of tokens to smart contracts which cannot interact with them. The Ethereum ecosystem is moving fast and support of ERC23 increases the safety of \ORT{} token usage for both end users and autonomous agents such as IoT devices.
