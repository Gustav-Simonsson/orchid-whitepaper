...
The software is being actively developed right now and is not yet
complete.


%% . The following
%% describes where we hope to be when we publicly release this
%% whitepaper.

%% \subsection{Software for the Ethereum Platform}

%% We have a ERC20 compliant token, a smart-contract implementing
%% stochastic micropayments as described in Section \ref{sec:payments},
